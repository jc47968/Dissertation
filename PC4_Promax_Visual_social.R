...
setwd(r"[C:\Users\jason\OneDrive\Desktop\NCU\Dissertation Dataset\Disseration Analysis\04 Princple Component Analysis\Promax Factor Visual_SOC]")

loadings <- read_csv("component_15_loadings_soc.csv", col_names = FALSE)
