...
setwd(r"[C:\Users\jason\OneDrive\Desktop\NCU\Dissertation Dataset\Disseration Analysis\04 Princple Component Analysis\Varimax Factor PC4 Visual]")

loadings <- read_csv("component_4_loadings.csv", col_names = FALSE)
